...
export function CompetitionCard({ competition, onClick }: CompetitionCardProps) {
  ...
  return (
    <div 
      onClick={onClick}
      className="bg-slate-900 border border-slate-700 rounded-xl p-3 cursor-pointer transform transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] hover:border-blue-600 w-full max-w-full mx-auto"
    >
      <div className="flex items-center gap-3 min-w-0">
        ...
        <div className="text-right flex-shrink-0 min-w-0 max-w-[80px]">
